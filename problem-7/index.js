function highestScore(students) {
    ...
    for (let i = 0; i < students.length; i++) {
        ...
        // Jika kelas belum ada di objek scores, atau skor siswa lebih tinggi daripada skor tertinggi saat ini
        if (!scores[className] || student.score > scores[className].score) {
            scores[className] = {
                name: student.name,
                score: student.score
            };
